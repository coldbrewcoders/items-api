...
const { validateSession, createSession, removeSession } = require("../grpc/session");

// Configure auth service grpc methods
server.addService(sessionPackage.SessionService.service, { validateSession, createSession, removeSession });
